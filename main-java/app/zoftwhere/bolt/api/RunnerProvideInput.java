...
/**
 * Runner provide input interface.
 *
...
public interface RunnerProvideInput extends AbstractUnit.Input<RunnerProgramInput> {
   ...
   * Specify the input.
   *
   * <p>The variable-argument input will be converted to a program input {@link java.io.InputStream}
   * with the {@link java.nio.charset.Charset} provided.
   *
