...
public class DelugeBuilder {
  ...
  public static DelugeBuilder from(
      DelugeProgramType type, DelugeSetting setting, DelugeData input) {
   ...
   */
  public static DelugeBuilder from(
      Charset encoding, DelugeProgramType type, DelugeSetting setting, DelugeData input) {
  ...
  public static List<DelugeSetting> programSetting(
      List<String[]> argumentList, List<Exception> errorList, List<Charset> charsetList) {
