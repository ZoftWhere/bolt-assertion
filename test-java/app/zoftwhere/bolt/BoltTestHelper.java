...
public class BoltTestHelper {
  ...
  public static InputStream transcode(
      InputStream inputStream, Charset source, Charset destination) {
  ...
  private static <T> String publicConstructorString(Class<T> clazz, Class<?>[] parameters) {
    final var builder = new StringBuilder("public").append(" ").append(clazz.getName()).append("(");
